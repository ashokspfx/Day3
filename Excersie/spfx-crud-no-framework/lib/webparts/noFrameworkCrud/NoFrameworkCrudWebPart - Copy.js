...
var NoFrameworkCrudWebPart = (function (_super) {
    ...
    NoFrameworkCrudWebPart.prototype.createItem = function () {
        ...
        this.getListItemEntityTypeName()
            ...
            return _this.context.spHttpClient.post(_this.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('" + _this.properties.listName + "')/items", SPHttpClient.configurations.v1, {
                headers: {
    ...
    NoFrameworkCrudWebPart.prototype.updateItem = function () {
        ...
        this.getListItemEntityTypeName()
            ...
            .then(function (item) {
            _this.updateStatus("Updating item with ID: " + latestItemId + "...");
            var body = JSON.stringify({
                '__metadata': {
                    'type': listItemEntityTypeName
                },
    ...
    NoFrameworkCrudWebPart.prototype.getListItemEntityTypeName = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            _this.context.spHttpClient.get(_this.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('" + _this.properties.listName + "')?$select=ListItemEntityTypeFullName", SPHttpClient.configurations.v1, {
                headers: {
                    'Accept': 'application/json;odata=nometadata',
                    'odata-version': ''
                }
...
//# sourceMappingURL=NoFrameworkCrudWebPart - Copy.js.map
